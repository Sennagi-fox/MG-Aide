...
--云控
import "com.androlua.Http"
Http.get("https://cdn.lightxi.com/cloudreve/uploads/2023/03/04/9KGzqkb8_%E9%9D%99%E6%80%81.txt",nil,nil,nil,function(code,content)
--图片
    图片1=content:match("【图1】(.-)【图1】")       
    图片2=content:match("【图2】(.-)【图2】")    
    图片3=content:match("【图3】(.-)【图3】")    
    图片4=content:match("【图4】(.-)【图4】")     
    图片6=content:match("【图5】(.-)【图5】")
    
    下载1=content:match("【一】(.-)【一】")       
    下载2=content:match("【二】(.-)【二】")    
    下载3=content:match("【专辑】(.-)【专辑】")    
    下载4=content:match("【演唱会】(.-)【演唱会】")
...
function card.onClick()  
  activity.newActivity("htr")
  activity.overridePendingTransition(R.anim.fragment_open_enter,R.anim.fragment_close_exit)
  
end

function ca.onClick()  
  activity.newActivity("dmg")
  activity.overridePendingTransition(R.anim.fragment_open_enter,R.anim.fragment_close_exit)
