    ...
    gravity="left|center",--重力居左｜置中    
       {
        ...
        id="hdlc";
   ...
   
         {
          ...
          layout_marginRight='20dp';--右距
          layout_marginTop='323dp';--顶距
          text="曲库",
          textSize="33sp",
          textStyle="bold",
          textColor="#FF4A3B40";--文字颜色
          id="t000",
          },      
         },
       {
         ...
         }, 
       {
        ...
        layout_marginTop="0dp",--顶距   
        CardBackgroundColor=卡片底色,    
        elevation='0dp';--阴影elevation='0dp';--阴影
        id="hdlc4";
         {
          MaterialCardView;--卡片控件
          layout_margin='0dp';--边距
...
function dlc.onClick()
  activity.newActivity("mu1")
  activity.overridePendingTransition(R.anim.fragment_open_enter,R.anim.fragment_close_exit)
end
function hdlc.onClick()
  activity.newActivity("mu1")
  activity.overridePendingTransition(R.anim.fragment_open_enter,R.anim.fragment_close_exit)
end

function dlc2.onClick()
  activity.newActivity("mu2")
  activity.overridePendingTransition(R.anim.fragment_open_enter,R.anim.fragment_close_exit)
end
function hdlc2.onClick()
  activity.newActivity("mu2")
  activity.overridePendingTransition(R.anim.fragment_open_enter,R.anim.fragment_close_exit)
end

function dlc3.onClick()
  activity.newActivity("mu3")
  activity.overridePendingTransition(R.anim.fragment_open_enter,R.anim.fragment_close_exit)
end
function hdlc3.onClick()
  activity.newActivity("mu3")
  activity.overridePendingTransition(R.anim.fragment_open_enter,R.anim.fragment_close_exit)
end

function dlc4.onClick()
  activity.newActivity("mu4")
  activity.overridePendingTransition(R.anim.fragment_open_enter,R.anim.fragment_close_exit)
end
function hdlc4.onClick()
  activity.newActivity("mu4")
  activity.overridePendingTransition(R.anim.fragment_open_enter,R.anim.fragment_close_exit)
end

function dlc5.onClick()
  activity.newActivity("mu5")
  activity.overridePendingTransition(R.anim.fragment_open_enter,R.anim.fragment_close_exit)
end
function hdlc5.onClick()
  activity.newActivity("mu5")
  activity.overridePendingTransition(R.anim.fragment_open_enter,R.anim.fragment_close_exit)
end

function dlc6.onClick()
  activity.newActivity("mu6")
  activity.overridePendingTransition(R.anim.fragment_open_enter,R.anim.fragment_close_exit)
end
function hdlc6.onClick()
  activity.newActivity("mu6")
  activity.overridePendingTransition(R.anim.fragment_open_enter,R.anim.fragment_close_exit)
end
