...
--云控更新日志
import "com.androlua.Http"
Http.get("https://cdn.lightxi.com/cloudreve/uploads/2024/06/28/2O2RtFq0_%E5%A4%A7%E6%94%B9%E5%8A%A8.txt",nil,nil,nil,function(code,content)
  链接=content:match("【转接】(.-)【转接】")
 

Http.get(链接,nil,nil,nil,function(code,content)
